...
function displayMessage() {
  ...
  console.log(replaceFirstOccurence("What is the color of the sky?", "the", "water"));
  console.log(replaceAllOccurrences("What is the color of the sky?", "the", "water"));
  console.log(encode("What is the color of the sky?"));
	console.log(palindrome("What is the color of the sky?"));
  console.log(pigLatin("What is the color of the sky?", "-s"));
}
